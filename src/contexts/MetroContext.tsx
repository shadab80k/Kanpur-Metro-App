...
export const MetroProvider: React.FC<MetroProviderProps> = ({ children }) => {
  ...
  // Language locked to English - Hindi coming soon
  ...
  const switchLanguage = () => {
    // Language switching disabled - Hindi support coming soon
    console.log("Language switching temporarily disabled - Hindi support coming soon!");
  };
  
  const setLanguage = (lang: Language) => {
    // Language setting disabled - Hindi support coming soon
    console.log("Language setting temporarily disabled - Hindi support coming soon!");
  };
  ...
  const getLocalizedText = (key: string): string => {
    const translations: { [key: string]: { English: string; Hindi: string } } = {
      ...
      "Calculate Fare": { English: "Calculate Fare", Hindi: "किराया गणना करें" },
      "Calculating...": { English: "Calculating...", Hindi: "गणना हो रही है..." },
      "From": { English: "From", Hindi: "से" },
      "To": { English: "To", Hindi: "तक" },
      "Regular Ticket": { English: "Regular Ticket", Hindi: "सामान्य टिकट" },
      "Smart Card": { English: "Smart Card", Hindi: "स्मार्ट कार्ड" },
      "You save": { English: "You save", Hindi: "आप बचाते हैं" },
      "Calculate Another Fare": { English: "Calculate Another Fare", Hindi: "दूसरा किराया गणना करें" },
      "Fare Information": { English: "Fare Information", Hindi: "किराया जानकारी" },
      "Smart card users get 10% discount on fares": { English: "Smart card users get 10% discount on fares", Hindi: "स्मार्ट कार्ड उपयोगकर्ताओं को किराए पर 10% छूट मिलती है" },
      "Children below 90cm height travel free": { English: "Children below 90cm height travel free", Hindi: "90 सेमी से कम ऊंचाई वाले बच्चे मुफ्त यात्रा करते हैं" },
      "Senior citizens (60+ years) get 10% discount with ID": { English: "Senior citizens (60+ years) get 10% discount with ID", Hindi: "वरिष्ठ नागरिक (60+ वर्ष) पहचान पत्र के साथ 10% छूट पाते हैं" },
      "Group tickets available for 5 or more passengers": { English: "Group tickets available for 5 or more passengers", Hindi: "5 या अधिक यात्रियों के लिए समूह टिकट उपलब्ध" },
      ...
      "Position": { English: "Position", Hindi: "स्थिति" },
      "Access": { English: "Access", Hindi: "पहुंच" },
      "Accessibility": { English: "Accessibility", Hindi: "पहुंच" },
      "Inside": { English: "Inside", Hindi: "अंदर" },
      "Outside": { English: "Outside", Hindi: "बाहर" },
      "Yes": { English: "Yes", Hindi: "हां" },
      "No": { English: "No", Hindi: "नहीं" },
      "Accessible": { English: "Accessible", Hindi: "सुगम" },
      "Not accessible": { English: "Not accessible", Hindi: "सुगम नहीं" },
      "Use this station for journey planning": { English: "Use this station for journey planning", Hindi: "यात्रा योजना के लिए इस स्टेशन का उपयोग करें" }
    };
